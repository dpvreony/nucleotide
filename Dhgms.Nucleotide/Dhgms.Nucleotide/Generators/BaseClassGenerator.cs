...
//            {
//                sb.AppendLine(
//                    "        /// <param name=\"" + OldHelpers.GetVariableName(pi.Name) + "\">" + pi.Description + "</param>");
//            }
//        }
...
//                {
//                    sb.Append("                " + OldHelpers.GetVariableName(baseClassProperties[counter].Name));
//                    counter++;
...
//            foreach (PropertyInfoBase pi in properties)
//            {
//                sb.AppendLine("            this." + pi.Name + " = " + OldHelpers.GetVariableName(pi.Name) + ";");
//            }
...
//                        + OldHelpers.GetVariableName(baseClassProperties[counter].Name) + ",");
//                    counter++;
//                }
...
//                    + OldHelpers.GetVariableName(properties[counter].Name));
//                counter++;
...
//                {
//                    sb.AppendLine("            this." + OldHelpers.GetVariableName(pi.Name) + " = null;");
//                }
//                else if (pi.DisposableType)
//                {
//                    sb.AppendLine("            this." + OldHelpers.GetVariableName(pi.Name) + ".Dispose();");
//                }
//            }
