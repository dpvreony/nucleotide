...
namespace Dhgms.Nucleotide.Generators
{
    ...
    public abstract class UnitTestBase
    {
        ...
        private void DoUnitTestUsingStatements(StringBuilder sb, int tabCount)
        {
            ...
            sb.AppendLine(string.Format(CultureInfo.InvariantCulture, "{0}using NUnit.Framework;", Helpers.GetTabs(tabCount)));
        ...
        {
            sb.AppendLine("#if NUNIT");
            sb.AppendLine("{0}[Test]", Helpers.GetTabs(tabCount));
            sb.AppendLine("#elif XUNIT");
            sb.AppendLine("{0}[Fact]", Helpers.GetTabs(tabCount));
            sb.AppendLine("#elif MSTEST");
            sb.AppendLine("{0}[TestMethod]", Helpers.GetTabs(tabCount));
            sb.AppendLine("#else");
            sb.AppendLine("#error MSTEST, NUNIT or XUNIT must be defined as a build symbol constant.");
            sb.AppendLine("#endif");
        }
        ...
        {
            sb.AppendLine("#if NUNIT");
            sb.AppendLine("{0}[TestFixture]", Helpers.GetTabs(tabCount));
            sb.AppendLine("#elif XUNIT");
            sb.AppendLine("#elif MSTEST");
            sb.AppendLine("{0}[TestClass]", Helpers.GetTabs(tabCount));
            sb.AppendLine("#else");
            sb.AppendLine("#error MSTEST, NUNIT or XUNIT must be defined as a build symbol constant.");
            sb.AppendLine("#endif");
        }
        ...
        {
            sb.AppendLine(Helpers.GetTabs(indentCount) + "[Test]");
