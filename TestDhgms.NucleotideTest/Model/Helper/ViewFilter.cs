// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ViewFilter.cs" company="DHGMS Solutions">
...
namespace TestDhgms.NucleotideTest.Model.Helper
{
    ...
    public class ViewFilter
    {
        ...
        /// The class remarks.
        /// </summary>
        private const string ClassRemarks = "Unit test for ViewFilter class code generation";
        ...
        private readonly Base[] propertiesDefault = new Base[]
            {
               new ClrBoolean(CollectionType.None, "BooleanItem", "A Boolean Item", false, true, null) 
            };
        ...
        private readonly Base[] propertiesInheriting = new Base[]
            {
               new ClrBoolean(CollectionType.None, "BooleanNullableItem", "A Boolean Item", true, true, null) 
            };
        ...
        /// <summary>
        /// The test view filter all arguments null.
        /// </summary>
        [TestMethod]
        public void TestViewFilterAllArgumentsNull()
        {
            var instance = new Dhgms.Nucleotide.Model.Helper.ViewFilter();
        ...
        /// <summary>
        /// The test view filter class name null.
        /// </summary>
        [TestMethod]
        public void TestViewFilterClassNameNull()
        {
            var instance = new Dhgms.Nucleotide.Model.Helper.ViewFilter();
        ...
        /// <summary>
        /// The test view filter class remarks null.
        /// </summary>
        [TestMethod]
        public void TestViewFilterClassRemarksNull()
        {
            var instance = new Dhgms.Nucleotide.Model.Helper.ViewFilter();
        ...
        /// <summary>
        /// The test view filter inheriting should succeed.
        /// </summary>
        [TestMethod]
        public void TestViewFilterInheritingShouldSucceed()
        {
            var instance = new Dhgms.Nucleotide.Model.Helper.ViewFilter();
            instance.Generate(
                MainNamespaceName, 
        ...
        /// <summary>
        /// The test view filter main namespace name null.
        /// </summary>
        [TestMethod]
        public void TestViewFilterMainNamespaceNameNull()
        {
            var instance = new Dhgms.Nucleotide.Model.Helper.ViewFilter();
        ...
        /// <summary>
        /// The test view filter no base should succeed.
        /// </summary>
        [TestMethod]
        public void TestViewFilterNoBaseShouldSucceed()
        {
            var instance = new Dhgms.Nucleotide.Model.Helper.ViewFilter();
            instance.Generate(
        ...
        /// <summary>
        /// The test view filter properties null.
        /// </summary>
        [TestMethod]
        public void TestViewFilterPropertiesNull()
        {
            var instance = new Dhgms.Nucleotide.Model.Helper.ViewFilter();
