...
namespace Dhgms.Nucleotide.Generators.Features.AspNetCore.MvcControllers
{
            ...
            Name)
    {
            ...
            NamedTypeModel loggerMessageActionsModel)
        {
            ...
            var baseTypeSyntaxFunc = () => SyntaxFactory.SimpleBaseType(SyntaxFactory.ParseTypeName($"global::Whipstaff.AspNetCore.AbstractQueryOnlyMvcController<{listQueryClassName}, {listRequestDtoClassName}, {listResponseDtoClassName}, {viewQueryClassName}, {viewResponseDtoClassName}, {logMessageActionsWrapperClassName}>"));
        ...
        private static MethodDeclarationSyntax GetMvcViewActionResultDeclaration(NamedTypeModel responseClassName, string action)
        {
            ...
            var baseMethodInvocationSyntax =
                RoslynGenerationHelpers.GetMethodOnClassInvocationSyntax("View", new[] { $"\"{camelAction}\"", $"{lowerAction}Response" }, false);
