    ...
    public static class SignalRHubInterfaceGeneratorTests
    {
        public sealed class ConstructorMethod
        {
            ...
            public void ThrowsArgumentNullException()
            {
                ...
                var exception = Assert.Throws<ArgumentNullException>(() => new SignalRHubInterfaceGenerator(null));
            ...
            public void ReturnsInstance()
            {
                ...
                var instance = new SignalRHubInterfaceGenerator(attributeData.Object);
