...
//        {
//            sb.AppendLine(
//                "            " + pi.GetCSharpDataTypeDeclaration() + " " + OldHelpers.GetVariableName(pi.Name) + " = "
//                + pi.DefaultValue + ";");
//            sb.AppendLine("            if(" + OldHelpers.GetVariableName(pi.Name) + "Ordinal > -1)");
//            sb.AppendLine("            {");
//            sb.AppendLine(
//                "                " + OldHelpers.GetVariableName(pi.Name) + " = dataReader.Get" + pi.SqlDataReaderType + "("
...
//                                  ? "new "
//                                  : "override ";
//            sb.AppendLine("        public " + modifier + className + this.GetClassSuffix() + " GetStronglyTypedObjectFromDataReaderRow(System.Data.OldHelpers.DbDataReader dataReader)");
//            sb.AppendLine("        {");
...
//            if (baseClassProperties != null && baseClassProperties.Length > 0)
//            {
//                sb.AppendLine("                " + OldHelpers.GetVariableName(baseClassProperties[0].Name));
//                for (int i = 1; i < baseClassProperties.Length; i++)
//                {
//                    sb.AppendLine("                ," + OldHelpers.GetVariableName(baseClassProperties[i].Name));
//                }
//            }

//            string comma = (baseClassProperties != null && baseClassProperties.Length > 0) ? "," : null;
//            sb.AppendLine("                " + comma + OldHelpers.GetVariableName(properties[0].Name));
//            for (int i = 1; i < properties.Length; i++)
//            {
//                sb.AppendLine("                ," + OldHelpers.GetVariableName(properties[i].Name));
//            }
