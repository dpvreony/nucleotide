...
//            IList<IEntityGenerationModel> classes,
...
//        protected abstract void DoGenerationOfClass(StringBuilder sb, IEntityGenerationModel entityGenerationModel);
...
//        private string DoGeneration(IList<IEntityGenerationModel> classes, bool doCopyrightHeader)
//        {
//            if (classes == null)
//            {
...
//            var classesClone = new List<IEntityGenerationModel>(classes);
...
//        private void DoGenerationOfMainNameSpace(StringBuilder sb, KeyValuePair<string, IDictionary<string, IList<IEntityGenerationModel>>> sortedMainNamespace)
//        {
...
//        private static IEnumerable<KeyValuePair<string, IDictionary<string, IList<IEntityGenerationModel>>>> SortMainNameSpaces(IList<IEntityGenerationModel> classes)
//        {
//            var mainNamespaces = classes.Select(x => x.MainNamespaceName).Distinct().OrderBy(x => x).ToList();

//            var mappings = new Dictionary<string, IDictionary<string, IList<IEntityGenerationModel>>>(mainNamespaces.Count);
...
//        private static IDictionary<string, IList<IEntityGenerationModel>> SortSubNamespaces(IList<IEntityGenerationModel> classes)
//        {
//            var subNamespaces = classes.Select(x => x.SubNamespace).Distinct().OrderBy(x => x).ToList();

//            var mappings = new Dictionary<string, IList<IEntityGenerationModel>>(subNamespaces.Count);
